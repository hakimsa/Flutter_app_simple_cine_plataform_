  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      child: Card(
        child: Column(
          children: <Widget>[
            ListTile(title: Text("Titulo   "), subtitle: Text("la descripcion de video")),
            GestureDetector(
...
class _Video_showState extends State<Video_show>
  ...
  VideoPlayerController.asset('assets/videos/infogra.mp4');

  // TODO(sigurdm): This should not be stored here.
  static const String beeUri =
      'assets/videos/infogra.mp4';
  final VideoPlayerController beeController =
  VideoPlayerController.network(beeUri);
